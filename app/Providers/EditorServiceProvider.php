...
use PHPolygon\Editor\Command\GetPrefabBaselineCommand;
...
class EditorServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(EditorCommandBus::class, function ($app) {
            ...
            $bus->register('duplicate_entity', DuplicateEntityCommand::class);
            ...
            $bus->register('update_properties', UpdatePropertiesCommand::class);
            ...
            $bus->register('list_shader_assets', ListShaderAssetsCommand::class);
            $bus->register('load_shader_asset', LoadShaderAssetCommand::class);
            ...
            $bus->register('create_prefab_class', CreatePrefabClassCommand::class);
            $bus->register('get_prefab_baseline', GetPrefabBaselineCommand::class);
            $bus->register('revert_prefab_override', RevertPrefabOverrideCommand::class);
            $bus->register('load_prefab_class', LoadPrefabClassCommand::class);
            $bus->register('convert_prefab_asset', ConvertPrefabAssetCommand::class);
